...
export const GateFiIdtoAssetIds = (id: string): string => GateFiIdtoAssetIdmap[id]
...
export const AssetIdToGateFiIds = (id: string): string => AssetIdsToGateFiIdMap[id]